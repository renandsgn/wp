...
gulp.task("css-concat", function () {
	return gulp.src(["../css/reset.css", "!../css/mixins.css", "../css/common.css"]).pipe(gp_concat("common.css")).pipe(cssmin()).pipe(gulp.dest("../dist/css"));
});
...
gulp.task("assistir", function () {
	connect.server({}, function () {
		browserSync({
			// open: 'external',
			host: "localhost:8443",
			proxy: "https://localhost:8443/youlosty",
			// baseDir: "../",
			online: true,
			ghostMode: false,
			https: true,
	...
	gulp.watch("../js/**/*.js", gulp.series("js-teste"));
