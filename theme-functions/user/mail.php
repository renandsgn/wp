...
<body style="background-color: #000;">
    <div class="container">
        <div class="header">
            ...
            <h1 style="color: #fff;"><?php echo custom_lang('Confirm your account', 'Confirme sua conta') ?></h1>
        </div>
        <div class="content">
            <p style="color: #fff;"><?php echo custom_lang('Hi, Please, click on the button below to confirm your account:', 'Olá, Por favor, clique no botão abaixo para confirmar sua conta:') ?></p>
            <p><a style="color: #000;" class="button" href="<?php echo esc_url($url); ?>"><?php echo custom_lang('Confirm my account', 'Confirmar minha conta') ?></a></p>
            <p style="color: #fff;"><?php echo custom_lang('If you did not create an account, please ignore this email.', 'Caso não tenha criado uma conta, por favor, ignore este e-mail.') ?></p><br>
        </div>
        <div class="footer">
